...
exports.parseStyles = exports.parseValues = exports.combine = exports.split = undefined;
...
var parseValues = exports.parseValues = function parseValues(startValue, endValue) {
  ...
  var startMatches = startValue.toString().match(numberUnitSplit);
  var endMatches = endValue.toString().match(numberUnitSplit);

  if (startMatches && endMatches) {
    var startUnit = startMatches[2];
    var endUnit = endMatches[2];
...
exports.toString = exports.omitEmptyValues = exports.appendToKeys = exports.calculateObsoleteValues = exports.calculateObsoleteFrames = exports.addValueToProperty = exports.getInterpolator = undefined;
